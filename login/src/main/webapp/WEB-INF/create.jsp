...
<div class="container">
    ...
    <div class="row justify-content-md-center">
        <div class="col-sm-12 col-md-6 col-lg-4 mt-5">
                <h3 class="text-center mt-4">Create New User</h3>
                <p>${error}</p>
                <form action="/user/create" method="post">
                    <div class="input-group mb-4 input-group-md">
                        <span class="input-group-text" id="username" style="width:20px">
                    ...
                    <div class="input-group mb-4 input-group-md">
                        <span class="input-group-text" id="displayName" style="width:20px">
                            <i class="fa fa-user"></i>
                        </span>
                    ...
                    <div class="input-group mb-4 input-group-md">
                        <span class="input-group-text" id="password" style="width:20px">
                            <i class="fa fa-user"></i>
                        </span>
                    ...
                    <div class="input-group mb-4 input-group-md">
                        <span class="input-group-text" id="cpassword" style="width:20px">
                            <i class="fa fa-user"></i>
                        </span>
